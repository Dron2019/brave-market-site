...
function paralaxWithWhiteTextLayoutAnim() {
  ...
  gsap
    ...
    // })
    .fromTo(
      el.querySelector('.home-about__img-transform'),
      {
        y: -400,
      },
      {
    ...
    .fromTo(
      el.querySelector('.home-about__img-scale'),
      {
        scale: 1.4,
      },
      {
...
function homeTextScreensAnimation() {
  ...
  document.querySelectorAll('.home-screen-3').forEach(screen => {
    gsap
      ...
      .fromTo(
        Array.from(screen.children).filter(el => !el.classList.contains('delimiter')),
        {
          y: '10%',
          opacity: 0,
        },
      ...
      .fromTo(
        screen.querySelector('.delimiter'),
        {
          scale: 0,
        },
        {
